        ...
        <div class="container text-center" style="background-color:darkgrey;">
            ...
            <?php 
                try{
                    ...
                    $smjena = $veza->prepare('select * from smjena');
          ...
          <a href="dodajsmjenu.php"><button type="button" class="btn btn-success btn-lg">Dodaj smjenu</button></a>
